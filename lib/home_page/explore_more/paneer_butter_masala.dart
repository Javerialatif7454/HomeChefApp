...
class _PaneerButterMasalaState extends State<PaneerButterMasala> {
  ...
  void toggleFavorite(String imagePath, String title, String price, bool isFavorite) async {
    if (isFavorite) {
      ...
      await DBHelper.deleteItem(imagePath); // Remove from database
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Paneer Butter Masala")),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            dealContainer(
              context,
              'assets/images/shop_categories/curry/paneer_butter_masala.jpeg',
              'Paneer Butter Masala',
              'Rs. 1299',
              'A rich, creamy curry with tender paneer pieces.',
            ),
            dealContainer(
              context,
